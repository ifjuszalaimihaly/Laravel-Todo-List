    ...
    <script>        
        $(document).ready(function () {
            ...
            $("#AddButton").click(function(){
                ...
                if(text == ""){
                    alert("Please type anithing to there");
                }
...
<body>
    <div class="container" style="margin-top: 20px">
        <div class="row">
            <div class="col-lg-offset-3 col-lg-6">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Ajax Todo list<a id="link" href="#" class="pull-right" data-toggle="modal" data-target="#myModal"><p><i class="fa fa-plus" aria-hidden="true"></i></p></a></h3>
                    </div>
            ...
            <div class="col-lg-2">
                <input type="text" class="form-control" name="item" id="search" placeholder="Search">
            </div>
